...
| Last CI run | 2026-05-19 22:20 UTC |
| Branch | `chore/quartz` |
| Commit | `22b0f1d` |
<!-- ci-environment-end -->
...
|---|---|---|---|---|---|---|---|---|---|
| Command `Send` | 47.56 ns | ±2.052 ns | 0 | 0 | 0 | - | ✅ -48 B | ~21.0M msg/s | ✅ improved (-47.5%) |
| Notification `Notify` | 30.71 ns | ±0.570 ns | 0 | 0 | 0 | - | ✅ -288 B | ~32.6M msg/s | ✅ improved (-76.2%) |
| Request `Request` | 76.71 ns | ±5.221 ns | 0.0043 | 0 | 0 | 72 B | ✅ -40 B | ~13.0M msg/s | ✅ improved (-14.7%) |
| Stream `RequestStream` | 140.65 ns | ±4.070 ns | 0.0076 | 0 | 0 | 128 B | ✅ -88 B | ~7.1M msg/s | ✅ improved (-28.3%) |
<!-- ci-throughput-end -->
...
Run: 2026-05-19 22:20 UTC | Branch: `chore/quartz` | Commit: `22b0f1d`
...
|---|---|---|---|---|
| Command `Send` | 90.55 ns | 47.56 ns | ✅ -47.5% | ✅ -48 B |
| Notification `Notify` | 128.85 ns | 30.71 ns | ✅ -76.2% | ✅ -288 B |
| Request `Request` | 89.91 ns | 76.71 ns | ✅ -14.7% | ✅ -40 B |
| Stream `RequestStream` | 196.07 ns | 140.65 ns | ✅ -28.3% | ✅ -88 B |