...
/// producing a response of type TResponse. This pattern is commonly used in mediator-based architectures to decouple
/// request and response handling.</remarks>
...
/// typically resulting in a response or action. Requests are commonly used in mediator patterns to decouple the sender
/// from the handler.</remarks>
