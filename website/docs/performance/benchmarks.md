...
| CPU | AMD EPYC 7763 2.78GHz, 1 CPU, 4 logical and 2 physical cores |
| .NET SDK | 10.0.203 |
| Runtime | .NET 10.0.7 (10.0.7, 10.0.726.21808), X64 RyuJIT x86-64-v3 |
| Last CI run | 2026-05-07 17:23 UTC |
...
|---|---|---|---|---|---|---|---|
| Command `Send` | 90.57 ns | ±0.061 ns | 0.0028 | 48 B | ✅ same | ~11.0M msg/s | ≈ (+0.0%) |
| Notification `Notify` | 208.77 ns | ±1.010 ns | 0.0256 | 432 B | ⚠️ +144 B | ~4.8M msg/s | ⚠️ degraded (+62.0%) |
| Request `Request` | 105.93 ns | ±0.480 ns | 0.0066 | 112 B | ✅ same | ~9.4M msg/s | ⚠️ degraded (+17.8%) |
| Stream `RequestStream` | 190.65 ns | ±2.026 ns | 0.0127 | 216 B | ✅ same | ~5.2M msg/s | ≈ (-2.8%) |
<!-- ci-throughput-end -->
...
Run: 2026-05-07 17:23 UTC | Branch: `copilot/add-gen-di-library-usage` | Commit: `d1c93f0`
...
|---|---|---|---|---|
| Command `Send` | 90.55 ns | 90.57 ns | ≈ +0.0% | ✅ same |
| Notification `Notify` | 128.85 ns | 208.77 ns | ⚠️ +62.0% | ⚠️ +144 B |
| Request `Request` | 89.91 ns | 105.93 ns | ⚠️ +17.8% | ✅ same |
| Stream `RequestStream` | 196.07 ns | 190.65 ns | ≈ -2.8% | ✅ same |