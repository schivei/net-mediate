...
| Last CI run | 2026-05-17 15:14 UTC |
...
|---|---|---|---|---|---|---|---|---|---|
| Command `Send` | 47.87 ns | ±5.747 ns | 0 | 0 | 0 | - | ✅ -48 B | ~20.9M msg/s | ✅ improved (-47.1%) |
| Notification `Notify` | 29.71 ns | ±0.970 ns | 0 | 0 | 0 | - | ✅ -288 B | ~33.7M msg/s | ✅ improved (-76.9%) |
| Request `Request` | 67.47 ns | ±2.284 ns | 0.0043 | 0 | 0 | 72 B | ✅ -40 B | ~14.8M msg/s | ✅ improved (-25.0%) |
| Stream `RequestStream` | 136.78 ns | ±19.992 ns | 0.0076 | 0 | 0 | 128 B | ✅ -88 B | ~7.3M msg/s | ✅ improved (-30.2%) |
<!-- ci-throughput-end -->
...
Run: 2026-05-17 15:14 UTC | Branch: `copilot/fix-duplicate-dependency-injection` | Commit: `f698549`
...
|---|---|---|---|---|
| Command `Send` | 90.55 ns | 47.87 ns | ✅ -47.1% | ✅ -48 B |
| Notification `Notify` | 128.85 ns | 29.71 ns | ✅ -76.9% | ✅ -288 B |
| Request `Request` | 89.91 ns | 67.47 ns | ✅ -25.0% | ✅ -40 B |
| Stream `RequestStream` | 196.07 ns | 136.78 ns | ✅ -30.2% | ✅ -88 B |