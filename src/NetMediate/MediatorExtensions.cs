...
public static class MediatorExtensions
{
    ...
    extension (IMediator mediator)
    {
        ...
        public Task<TResponse> Request<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken = default) =>
            RequestInvoker<TResponse>.Invoke(mediator, request, cancellationToken);
        ...
        public IAsyncEnumerable<TResponse> RequestStream<TResponse>(IStream<TResponse> message, CancellationToken cancellationToken = default) =>
            RequestStreamInvoker<TResponse>.Invoke(mediator, message, cancellationToken);
    }
    ...
    {
        private static readonly ConcurrentDictionary<Type, Func<IMediator, object, CancellationToken, Task<TResponse>>> s_cache =
            new();
        ...
        private static Func<IMediator, object, CancellationToken, Task<TResponse>> Create(Type requestType)
        {
