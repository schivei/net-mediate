...
| Last CI run | 2026-05-07 16:41 UTC |
...
|---|---|---|---|---|---|---|---|
| Command `Send` | 91.92 ns | ±0.485 ns | 0.0028 | 48 B | ✅ same | ~10.9M msg/s | ≈ (+1.5%) |
| Notification `Notify` | 203.27 ns | ±4.052 ns | 0.0256 | 432 B | ⚠️ +144 B | ~4.9M msg/s | ⚠️ degraded (+57.8%) |
| Request `Request` | 108.14 ns | ±0.761 ns | 0.0066 | 112 B | ✅ same | ~9.2M msg/s | ⚠️ degraded (+20.3%) |
| Stream `RequestStream` | 189.94 ns | ±2.578 ns | 0.0127 | 216 B | ✅ same | ~5.3M msg/s | ≈ (-3.1%) |
<!-- ci-throughput-end -->
...
Run: 2026-05-07 16:41 UTC | Branch: `copilot/add-gen-di-library-usage` | Commit: `65e350f`
...
|---|---|---|---|---|
| Command `Send` | 90.55 ns | 91.92 ns | ≈ +1.5% | ✅ same |
| Notification `Notify` | 128.85 ns | 203.27 ns | ⚠️ +57.8% | ⚠️ +144 B |
| Request `Request` | 89.91 ns | 108.14 ns | ⚠️ +20.3% | ✅ same |
| Stream `RequestStream` | 196.07 ns | 189.94 ns | ≈ -3.1% | ✅ same |